...
// 리엑트에서는 이미지를 반드시 경로로 참조해서 사용한다.
import logo from './logo.svg'

// 스타일 파일을 직접 만들어서 외부에서 참조 가능합니다.
import './App.css'
      ...
      <div className="App">
        <header className="App-header">
          ...
          <p style={{ backgroundColor: 'blue', color: 'red' }}>
            {userName} {userRole} 님 방문을 환영합니다.
          </p>

          {/* JSX요소는 반드시 홑태그라도 닫는형식이 필요하다. */}
          <br></br>

          {userName === '한고운' ? <h4>{userName} 님 반갑습니다.</h4> : <h4>게스트님 반갑습니다.</h4>}
